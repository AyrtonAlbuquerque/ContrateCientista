...
Os gráficos das figuras \ref{fig:pontuacoes} e \ref{fig:distribuicao} apresentam a pontuação média de cada inteligência e a distribuição de pontuações para todo o conjunto de dados.
